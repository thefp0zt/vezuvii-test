    ...
    <div class="container">
        ...
        <div class="navbar-header ">
            ...
            <a class="navbar-brand" href="#">
                <img src="../../resources/images/logo2.png" alt="" class="img-responsive">
            </a>
        </div><!--Navbar header End-->
        <nav class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li class="active">
                    <a href="index.jsp" data-scroll >Home </a>
                </li>
                <li>
                    <a href="index.jsp#service" data-scroll >Services</a>
                </li>
                <li>
                    <a href="index.jsp#portfolio"  data-scroll  >Portfolio </a>
                </li>
                <li>
                    <a href="index.jsp#about" data-scroll >About Us </a>
                </li>
                <li>
                    <a href="index.jsp#team" data-scroll  >Our Team </a>
                </li>

                <li>
                    <a href="index.jsp#blog" data-scroll  >Blog </a>
                </li>
                <li>
                    <a href="index.jsp#contact" data-scroll >Contact Us</a>
                </li>
            </ul>
        </nav>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
            <div class="portfolio-slider-wrapper">
                <ul id="portfolio-slider">
                    <li><img src="../../resources/images/slider/s2.jpg" alt="" class="img-responsive"/></li>
                    <li><img src="../../resources/images/slider/s1.jpg" alt="" class="img-responsive"/></li>
                    <li><img src="../../resources/images/slider/s3.jpg" alt="" class="img-responsive"/></li>
                </ul>
            </div>
            <div class="blog-desc">
            ...
            <div class="about-auther">
                ...
                <hr>
                <div class="well">
                    <img src="../../resources/images/team/pic1.jpg" alt="alt" class="img-responsive">
                    <p>Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Cras mattis consectetur purus sit amet fermentum. Donec id elit non mi porta gravida at eget metus.</p>
                </div>
            ...
            <div class="related-post">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="rel-post">
                        <a href="#">
                            <img src="../../resources/images/blog/pic6.jpg" alt="" lass="img-responsive">
                            <div class="caption">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="rel-post">
                        <a href="#">
                            <img src="../../resources/images/blog/pic7.jpg" alt="" lass="img-responsive">
                            <div class="caption">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="rel-post">
                        <a href="#">
                            <img src="../../resources/images/blog/pic8.jpg" alt="" lass="img-responsive">
                            <div class="caption">
                ...
                <ul class="media-list">
                    <li class="media">
                        <a class="media-left" href="#">
                            <img src="../../resources/images/team/pic5.jpg" alt="alt" class="img-responsive">
                        </a>
                    ...
                    <li class="media">
                        <a class="media-left" href="#">
                            <img src="../../resources/images/team/pic6.jpg" alt="alt" class="img-responsive">
                        </a>
                        <div class="media-body">
                ...
                <div class="blog-sidebar">
                        ...
                        <ul>
                            <li class="col-md-12 col-sm-4">
                                <div class="single-post">
                                    <a href="#"><img src="../../resources/images/blog/pic7.jpg" alt="post-img" class="img-responsive"></a>
                            ...
                            <li class="col-md-12 col-sm-4">
                                <div class="single-post">
                                    <a href="#"><img src="../../resources/images/blog/pic6.jpg" alt="post-img" class="img-responsive"> </a>
                                    <p>Ellentesque eleifend condimentum tellus.</p>
                                    <span>3 days ago</span>
                                </div>
                            </li>
                            <li class="col-md-12 col-sm-4">
                                <div class="single-post">
                                    <a href="#"><img src="../../resources/images/blog/pic10.jpg" alt="post-img" class="img-responsive"></a>
                                    <p>Ellentesque eleifend condimentum tellus.</p>
                                    <span>3 days ago</span>
                                </div>
                            </li>
                    ...
                    <div class="blog-catagory">
                        ...
                        <ul>
                            <li>
                                <a href="#">
                                    <i class="fa fa-angle-right"></i> Web Design <span class="badge">14</span>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <i class="fa fa-angle-right"></i>Social Media <span class="badge">23</span>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <i class="fa fa-angle-right"></i> Online Gaming <span class="badge">43</span>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <i class="fa fa-angle-right"></i>Technology <span class="badge">27</span>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <i class="fa fa-angle-right"></i>Photography <span class="badge">44</span>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <i class="fa fa-angle-right"></i>Economics <span class="badge">54</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="photo-stream">
                        <h4>Photo stream</h4>
                        <div class="b-stream">
                            <a href="#"><img src="../../resources/images/blog/pic6.jpg" alt="pic1" class="img-responsive"></a>
                        </div>
                        <div class="b-stream">
                            <a href="#"><img src="../../resources/images/blog/pic7.jpg" alt="pic1" class="img-responsive"></a>
                        </div>
                        <div class="b-stream">
                            <a href="#"><img src="../../resources/images/blog/pic8.jpg" alt="pic1" class="img-responsive"></a>
                        </div>
                        <div class="b-stream">
                            <a href="#"><img src="../../resources/images/blog/pic9.jpg" alt="pic1" class="img-responsive"></a>
                        </div>
                        <div class="b-stream">
                            <a href="#"><img src="../../resources/images/blog/pic10.jpg" alt="pic1" class="img-responsive"></a>
                        </div>
                        <div class="b-stream">
                            <a href="#"><img src="../../resources/images/blog/pic11.jpg" alt="pic1" class="img-responsive"></a>
                        </div>
                        <div class="b-stream">
                            <a href="#"><img src="../../resources/images/blog/pic12.jpg" alt="pic1" class="img-responsive"></a>
                        </div>
                        <div class="b-stream">
                            <a href="#"><img src="../../resources/images/blog/pic6.jpg" alt="pic1" class="img-responsive"></a>
                        </div>
...
<!-- initialize jQuery Library -->
<script type="text/javascript" src="../../resources/js/jquery2.js"></script>
<!-- Bootstrap jQuery -->
