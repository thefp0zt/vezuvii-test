        ...
        <div class="carousel-inner">
            <div class="item active">
                <div class="overlay-slide">
                    <img src="../../resources/images/banner/p5.jpg" alt="" class="img-responsive">
                </div>
            ...
            <div class="item">
                <div class="overlay-slide">
                    <img src="../../resources/images/banner/p3.jpg" alt="" class="img-responsive">
                </div>
                <div class="carousel-caption">
                    <div class="col-md-12 col-xs-12 text-center">
                        <h2>Везувий</h2>
            ...
            <div class="item">
                <div class="overlay-slide">
                    <img src="../../resources/images/banner/p10.jpg" alt="" class="img-responsive">
                </div>
                <div class="carousel-caption">
                    <div class="col-md-12 col-xs-12 text-center">
                        <h2>Везувий</h2>
...
<section id="portfolio">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="feature_header text-center">
                    ...
                    <h4 class="feature_sub"> Эти люди рискнули и сорвали куш! Здесь можешь появиться и ты! </h4>
                    <div class="divider"></div>
                </div>
            </div>  <!-- Col-md-12 End -->
        </div>
    ...
    <div id="isotope-filter" class="skew3 text-center">
        <a data-filter="*"  href="#" class="active ">Фото людей, которые не побоялись поставить и победить!</a>
    </div>
                    ...
                    <div class="tab-content main-tab-content">
                        <div role="tabpanel" class="tab-pane active " id="home">
                            <div class="col-md-12 col-sm-9">
                                <img src="../../resources/images/about/web1.png" alt="" class="img-responsive">
                            </div>
                            <div class="col-md-12 col-sm-9">
                                <div class="c-tab">
                        ...
                        <div role="tabpanel" class="tab-pane" id="profile">
                            <div class="col-md-12 col-sm-9">
                                <img src="../../resources/images/about/browse.png" alt="" class="img-responsive">
                            </div>
                            <div class="col-md-12 col-sm-9">
                                <div class="c-tab">
                        ...
                        <div role="tabpanel" class="tab-pane" id="photo">
                            <div class="col-md-12 col-sm-9">
                                <img src="../../resources/images/about/graphics.png" alt="" class="img-responsive">
                            </div>
                            <div class="col-md-12 col-sm-9">
                                <div class="c-tab">
