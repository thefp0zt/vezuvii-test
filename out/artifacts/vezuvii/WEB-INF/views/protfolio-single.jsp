    ...
    <div class="container">
        ...
        <nav class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li class="active">
                    <a href="index.jsp#slider_part" data-scroll  class="active">Home </a>
                </li>
                <li>
        ...
        <div class="row">
            <div class="related text-center">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="rel-post">
                        <a href="#">
                            <img src="../../resources/images/blog/pic6.jpg" alt="" class="img-responsive">
                            <div class="caption">
                                <h4>New speaker</h4>
                                <p>Graphics design</p>
                            </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="rel-post">
                        <a href="#">
                            <img src="../../resources/images/blog/pic7.jpg" alt="" class="img-responsive">
                            <div class="caption">
                                <h4>Skyscaper</h4>
                                <p>photograph</p>
                            </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="rel-post">
                        <a href="#">
                            <img src="../../resources/images/blog/pic8.jpg" alt="" class="img-responsive">
                            <div class="caption">
                                <h4>New website</h4>
                                <p>Web design</p>
                            </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="rel-post">
                        <a href="#">
                            <img src="../../resources/images/blog/pic11.jpg" alt="" class="img-responsive">
                            <div class="caption">
                                <h4>Top rider</h4>
                                <p>Wordpress</p>
                            </div>
